...
const ToDo = () => {
  ...
  return (
    <>
     <div className="bg-white border-l-4 border-violet-500 rounded-xl mb-6 cursor-pointer">
        <Card>
    ...
    <div className="bg-white border-l-4 border-violet-500 rounded-xl cursor-pointer">
        <Card>
            <CardHeader className="relative">
                <div className="flex items-center">
                    <CardTitle className="text-3xl font-bold flex-grow">BrainStroming</CardTitle>
